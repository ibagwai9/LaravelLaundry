...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <div class="row col-12">
      <div class="col-6">
        <h6 class="m-0 font-weight-bold text-primary btn-icon-split align-bottom">Role List</h6>
      </div>
      <div class="col-6">
            ...
            @foreach ($items as $index => $item)
              <tr>
                ...
                <td class="d-flex justify-content-center">
                  <a href="{{ route('dashboard::roles.edit', ['role' => $item->id, 'page' => $page]) }}" class="btn btn-info btn-circle btn-sm" title="Edit" style="margin:1px">
                    <span class="icon">
                      <i class="fas fa-pen-alt"></i>
                    </span>
                  </a>
                  <a href="{{ route('dashboard::roles.edit', ['role' => $item->id, 'page' => $page]) }}" class="btn btn-danger btn-circle btn-sm" title="Delete" style="margin:1px">
                    <span class="icon">
